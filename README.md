...
* 25 points - Report describes an analysis of the focal microbial dataset - it should not just be a set of figures, but should be a focused inquiry into some particular question you have about the data. It should include appropriate background to motivate the investigation, one or more hypotheses, your quantitative results (including somewhere around 4-5 tables/figures beyond what is included already in the template), and a discussion where you interpret the results. Report text should be between 2500 and 3000 words (not counting code), is well organized, free of spelling or grammar errors, and is written in proper scientific writing style. 
* 5 points - At least 5 sources properly cited in report
* 5 points - R code chunks are appropriately commented and well organized
* 5 points - Appropriate use of git to version control the steps, including adding and committing frequently as you work on this project, and writing informative and appropriately formatted commit messages
