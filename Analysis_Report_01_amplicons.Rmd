...
**Figure 4**: Inferred phylogeny of sequences, with points on tips representing samples within which each particular taxa occurred. Tree represents maximum likelihood phylogeny inferred using RAxML.
...
**Figure 5**: Bar plot of the phylum present by gender.
...
**Figure 6**: Bar plot of class present colored by gender.
